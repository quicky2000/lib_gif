...
namespace lib_gif
{
    ...
    class gif_image: public gif_graphic_rendering_block
    {
      public:
        ...
        inline
        gif_image( const uint16_t & p_image_width
        ...
        inline
        void set_color_index( const unsigned int & p_x
                            , const unsigned int & p_y
    ...
    //--------------------------------------------------------------------------
    const unsigned int & gif_image::get_color_index( const unsigned int & p_x
                                                   , const unsigned int & p_y
                                                   ) const
    {
    ...
    //--------------------------------------------------------------------------
    void gif_image::set_color_index( const unsigned int & p_x
                                   , const unsigned int & p_y
                                   , const unsigned int & p_index
                                   )
    {
