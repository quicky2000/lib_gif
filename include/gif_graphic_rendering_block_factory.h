...
namespace lib_gif
{
    class gif_graphic_rendering_block_factory
    {
      ...
      public:
        ...
        static inline
        gif_graphic_rendering_block & extract_block( const gif_data_block::t_gif_data_block_key & p_key
                                                   , std::ifstream & p_file
                                                   );
    ...
    //----------------------------------------------------------------------------
    gif_graphic_rendering_block & gif_graphic_rendering_block_factory::extract_block( const gif_data_block::t_gif_data_block_key & p_key
                                                                                    , std::ifstream & p_file
                                                                                    )
    {
