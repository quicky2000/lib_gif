...
namespace lib_gif
{
    ...
    class gif_lzw_decoder: public gif_lzw_base<T>
    {
      ...
      inline
      const gif_lzw_dictionnary_entry<T> & decode( const unsigned int & p_coded_value
    ...
    //----------------------------------------------------------------------------
    template<typename T>
    const gif_lzw_dictionnary_entry<T> & gif_lzw_decoder<T>::decode( const unsigned int & p_coded_value
                                                                   , unsigned int & p_current_code_size
                                                                   )
    {
