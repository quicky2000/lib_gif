    ...
    */
    class gif_graphic_block: public gif_data_block
    {
      ...
      public:
        ...
        inline
        gif_graphic_block( const gif_data_block::t_gif_data_block_key & p_key
                         , std::ifstream & p_file
                         );
    ...
    //----------------------------------------------------------------------------
    void gif_graphic_block::write(std::ostream & p_stream) const
    {
        assert(m_graphic_rendering_block);
        m_graphic_rendering_block->write(p_stream);
    }
