...
namespace lib_gif
{
    class gif_graphic_control_extension: public gif_extension_block
    {
      ...
      public:
        ...
        inline
        gif_graphic_control_extension( const unsigned int & p_delay_time_ms
    ...
    : gif_graphic_control_extension(0, false, 0)
    {
        ...
        {
            throw quicky_exception::quicky_logic_exception("Incomplete graphic control extension size", __LINE__, __FILE__);
        }
    ...
    //----------------------------------------------------------------------------
    void gif_graphic_control_extension::write_extension(std::ostream & p_stream) const
    {
        ...
        p_stream.write((char*)&m_packed_fields, sizeof(m_packed_fields));
        p_stream.write((char*)&m_delay_time, sizeof(m_delay_time));
        p_stream.write((char*)&m_transparent_color_index, sizeof(m_transparent_color_index));
    }
